...
```
bash <(curl -s https://raw.githubusercontent.com/ftadmi/wizwizxui-timebot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/ftadmi/wizwizxui-timebot/main/update.sh)
```
